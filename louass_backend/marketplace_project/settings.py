...
SECRET_KEY = 'django-insecure-r5ud4(s9k!m*e(1d^@%*f%=z9c^&_gf!@mb891rc*+1=z!wuhw'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # ou l'origine de ton frontend (React, Vue, etc.)
]
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=7),       # durée du token d’accès (avant refresh)
